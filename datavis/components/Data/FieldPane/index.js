 ...
 * @Last Modified time: 2018-12-03 15:26:49
 */
...
class FieldPane extends Component {
  ...
  renderFieldsList() {
    const content = field => (
      <Radio.Group onChange={this.fieldTypeChange.bind(this, field.field)} value={field.type}>
              ...
              <div>
                <span className="field-pill">
                  <span className="field-type">
                    <Popover title="TYPE" content={content(item)} placement="bottomLeft" trigger="click">
