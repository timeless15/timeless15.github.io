		...
		<div class="shopcart">
			<div class="content">
				...
				<div class="content-right" @click="pay">
					<div class="pay" :class="this.totalPrice<this.minPrice ? 'not-enough' : 'enough'" >
						{{payText}}
					</div>
				</div>
			</div>
...
export default {
	...
	computed: {
		totalCount() {
			var sum = 0;
			this.foodList.forEach(food => sum+=food.count)
			return sum;
		},
		totalPrice() {
			var sum = 0;
			this.foodList.forEach(food => sum += food.count*food.price);
			return sum;
		},
		payText() {
